...
def main(folder_path, balanced_csv_path, output_name):
    ...
    balanced_file_names = balanced_df.img_name.tolist()
...
if __name__ == "__main__":
    ...
    parser.add_argument("balanced_csv_path", type=str, help="Path to the csv containing the balanced dataset.") # pass eg child_balanced.csv
    parser.add_argument("output_name", type=str, help="Name of output file for run of balanced data.") # pass eg img_children_new_test
