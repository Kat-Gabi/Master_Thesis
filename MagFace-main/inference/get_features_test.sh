# This!! 
#PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True python gen_feat.py --inf_list toy_imgs_2/img.list --feat_list toy_imgs_2/feat.list --batch_size 1 --resume magface_iresnet18_casia_dp.pth
