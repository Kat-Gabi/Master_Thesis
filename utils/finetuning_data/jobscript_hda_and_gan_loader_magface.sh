...
#BSUB -q gpua100
### -- set the job Name --
#BSUB -J testjob_hda_and_gan_loader_magface
...
#BSUB -o hpc_out/%J/pipe_out_dev.out
#BSUB -e hpc_out/%J/pipe_err_dev.err
# -- end of LSF options --
...
export HF_HOME=/work3/s174139c
export TORCH_HOME=/work3/s174139


### Run python script

python GanDiff_loader_magface_cluster.py