...
adaface_models = {
    'ir_18': '/work3/s174139/Master_Thesis/AdaFace-master/scripts/experiments_gandiff/ir18_casia_adaface_06-02_0/GanDiff_FINAL_last.ckpt',#"/work3/s174139/Master_Thesis/AdaFace-master/scripts/experiments/ir18_casia_adaface_06-01_3_FINAL_9_LAYERS/last_RESULTING_ADAFACE_FINETUNED_MODEL.ckpt", #"pretrained/adaface_ir50_ms1mv2.ckpt",
}
...
class ToInputTransform:
    def __call__(self, pil_rgb_image):
        if pil_rgb_image is None:
            print("Image could not be opened:", pil_rgb_image)
            return None
...
if __name__ == '__main__':
    ...
    # Save the dictionary
    torch.save(data_dict, '/work3/s174139/Master_Thesis/data/data_full/feature_vectors/adaface_feature_vectors/similarity_scores_children_bibel_FINAL_INFERENCE_finetuning_2_2.pt')
